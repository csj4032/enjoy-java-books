...
public class EmployeeMapper extends AbstractMapper {
	...
	protected Employee doLoad(ResultSet resultSet) throws Exception {
		final DepartmentMapper departmentMapper = new DepartmentMapper();
		final Employee employee = new Employee(resultSet.getLong("ID"), resultSet.getString("NAME"), resultSet.getString("POSITION"), (Department) departmentMapper.load(resultSet));
		return employee;
	}

	@Override
	public EmployeeKey getKey(ResultSet resultSet) throws SQLException {
