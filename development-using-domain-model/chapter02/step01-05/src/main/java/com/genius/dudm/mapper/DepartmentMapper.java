...
public class DepartmentMapper extends AbstractMapper {
	...
	@Override
	protected Department doLoad(ResultSet resultSet) throws SQLException {
		return new Department(resultSet.getLong("DEPARTMENT_ID"), resultSet.getString("DEPARTMENT_NAME"), resultSet.getString("ADDRESS"));
	}

	@Override
	protected DepartmentKey getKey(ResultSet resultSet) throws SQLException {
		return new DepartmentKey(resultSet.getLong("DEPARTMENT_ID"));
	}
